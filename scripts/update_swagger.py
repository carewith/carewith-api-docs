...
def get_recent_issue():
    endpoint = GH_API_BASED_URL + "/repos/carewith/carewith-api-docs/issues"
...
def write_swagger_json(issue_body):
    with open("./meta-data.json", "r") as meta:
        ...
        json_data["info"]["description"] = "last updated : " + time.strftime('%Y-%m-%d %H:%M:%S') + "<br/>live: https://kauth.kakao.com/oauth/authorize?client_id=b4b9c60f1b384cecdc2553fabafb3ec3&redirect_uri=https://api.carewith.life/api/v1/auth/kakao/local&response_type=code<br/>local: https://kauth.kakao.com/oauth/authorize?client_id=b4b9c60f1b384cecdc2553fabafb3ec3&redirect_uri=https://api.carewith.life/api/v1/auth/kakao/local&response_type=code"
